        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-600 text-sm leading-relaxed mb-6 max-w-xs">
              Transform your body and mind with expert-led classes in a
              welcoming, supportive environment.
            </p>
            <div className="flex gap-3">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-600 hover:text-slate-900 hover:border-slate-300 hover:shadow-sm transition-all duration-300"
              ...
              <ul className="space-y-3">
                {column.links.map((link) => (
                  <li key={link.label}>
                    <a
                      href={link.href}
                      className="text-sm text-slate-600 hover:text-slate-900 transition-colors duration-200 inline-block"
                    >
                      {link.label}
                    </a>
                  </li>
        ...
        <div className="pt-8 border-t border-slate-200">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-slate-500">
              © {new Date().getFullYear()} Elevate Fitness Studio. All rights
              reserved.
            </p>
